 ...
 *       &lt;attribute name="apdu_hexstr" use="required">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 ...
 *       &lt;attribute name="expect_response">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
 *             &lt;pattern value="$.+|([0-9a-fA-F][0-9a-fA-F])+(,[^,]+,[0-9]+)?"/>
 *           &lt;/restriction>
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *     &lt;/restriction>
...
@XmlType(name = "")
@XmlRootElement(name = "mt_simpool")
public class MtSimpool implements Locatable
{
    ...
    @XmlAttribute(name = "apdu_hexstr", required = true)
    protected String apduHexstr;
    @XmlAttribute(name = "expect_ret")
    protected String expectRet;
    @XmlAttribute(name = "expect_response")
    protected String expectResponse;
    @XmlLocation
    @XmlTransient
     ...
     *     
     */
    public void setApduHexstr(String value) {
        this.apduHexstr = value;
    }
     ...
     *     
     */
    public void setExpectResponse(String value) {
        this.expectResponse = value;
    }
