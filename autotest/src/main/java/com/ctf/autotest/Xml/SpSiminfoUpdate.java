 ...
 *       &lt;sequence>
 *         &lt;element ref="{}sim_info" maxOccurs="unbounded"/>
 *       &lt;/sequence>
...
@XmlRootElement(name = "sp_siminfo_update")
public class SpSiminfoUpdate implements Locatable
{

    @XmlElement(name = "sim_info", required = true)
