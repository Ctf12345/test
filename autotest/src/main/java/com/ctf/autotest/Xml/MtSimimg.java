 ...
 *       &lt;attribute name="expect_img_data">
 *         &lt;simpleType>
 *           &lt;restriction base="{http://www.w3.org/2001/XMLSchema}string">
...
@XmlType(name = "")
@XmlRootElement(name = "mt_simimg")
public class MtSimimg implements Locatable
{
    ...
    @XmlAttribute(name = "expect_img_data")
    protected String expectImgData;
    @XmlLocation
    @XmlTransient
     ...
     *     
     */
    public String getExpectImgData() {
        return expectImgData;
    }
     ...
     *     
     */
    public void setExpectImgData(String value) {
        this.expectImgData = value;
    }
